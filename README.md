...
* Full details of the project can be found in the Jupyter notebook, [HERE](https://github.com/Matthew-AI-Dev/INSIGHT-project/blob/master/Motion_analyzer.ipynb).
...
* For testing purposes, if a YouTube video needs to be downloaded, this notebook can be used, [HERE](https://github.com/Matthew-AI-Dev/INSIGHT-project/blob/master/download_video.ipynb).
